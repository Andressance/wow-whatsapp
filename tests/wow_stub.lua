...
-- WoWWhatsApp.lua outside the game (see addon_test.js). Frames are plain tables:
...
-- The character, for the game context (WoWWhatsApp.GameContext).
function GetBuildInfo() return "12.1.0", "120100", "Sep 1 2026", 120100 end
